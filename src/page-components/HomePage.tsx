...
import { Campaign, Testimonial, CommunityStory, Donation } from '../types';
...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  const janazahCampaigns = campaigns.filter((c) => c.category === 'Janazah' || c.title.toLowerCase().includes('janazah'));
  const marriageCampaigns = campaigns.filter((c) => c.category === 'Marriage');
