...
const UserRow: React.FC<{
  ...
  return (
    <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
      ...
      <td className="px-4 py-3">
        <span
          className={`inline-block whitespace-nowrap px-2.5 py-0.5 rounded text-[10px] font-bold ${
              ...
              <form id="user-form" onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
                  <div>
                    ...
                    <label
                      className={`p-3 rounded-2xl border-2 border-dashed text-center cursor-pointer transition-all flex flex-col items-center justify-center relative h-20 ${
