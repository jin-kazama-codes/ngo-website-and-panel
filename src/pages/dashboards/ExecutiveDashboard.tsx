...
import { MOCK_PENDING_QUEUE, MOCK_AUDIT_LOGS } from '../../data/mockData';
import { PendingVerificationItem } from '../../types';
import { UserCheck, ShieldCheck, FileText, Check, X, Eye, AlertTriangle, CheckCircle2 } from 'lucide-react';

export const ExecutiveDashboard: React.FC = () => {
  const [queue, setQueue] = useState<PendingVerificationItem[]>(MOCK_PENDING_QUEUE);
