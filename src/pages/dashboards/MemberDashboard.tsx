...
import { ShieldCheck, Heart, Download, Building2, CheckCircle2, ArrowRight, FileText, QrCode } from 'lucide-react';
...
export const MemberDashboard: React.FC<MemberDashboardProps> = ({
  ...
  const userDonations = MOCK_DONATIONS.filter((d) => d.donorName.includes('Aarif') || d.donorId === user.id || d.id === 'don_805');
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-5 rounded-2xl bg-white border border-slate-100 shadow-sm">
          ...
          <span className="text-[11px] text-slate-500 mt-1 block">Across 4 Verified Causes</span>
        </div>
